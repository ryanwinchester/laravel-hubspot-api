...
class LeadNurturing extends BaseClient {
    ...
    **/
    public function all($excludeInactive)
    {
        $endpoint = 'campaigns';
        if ($excludeInactive) {
    ...
    * @throws HubSpotException
    **/
    public function list($campaignGuid)
    {
    ...
    * @throws HubSpotException
    **/
    public function history($leadGuid)
    {
    ...
    * @throws HubSpotException
    **/
    public function enroll($campaignGuid, $leadGuid)
    {
    ...
    * @throws HubSpotException
    **/
    public function remove($campaignGuid, $leadGuid)
    {
