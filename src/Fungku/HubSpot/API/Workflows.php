...
class Workflows extends BaseClient {
	...
	* @throws HubSpotException
	**/
	public function enrollContact($wfID, $email)
	{
	...
	* @throws HubSpotException
	**/
	public function unenrollContact($wfID, $email)
	{
		$endpoint = 'workflows/'.$wfID.'/enrollments/contacts/'.$email;
		try {
	...
	* @throws HubSpotException
	**/
	public function contactEnrollments($vid)
	{
	...
	* @throws HubSpotException
	**/
	public function getLogEvents($wfID, $vid, $params)
	{
	...
	* @throws HubSpotException
	**/
	public function upcomingEvents($wfID, $vid, $params)
	{
