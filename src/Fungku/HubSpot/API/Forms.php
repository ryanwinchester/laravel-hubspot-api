...
class Forms extends BaseClient {
	...
	**/
	public function submit($portalId, $guid, $form_fields, $hs_context)
	{
	...
	*@throws HubSpotException
	**/
	public function create($form_data, $fields)
	{
		$endpoint = 'forms';
	...
	*@throws HubSpotException
	**/
	public function update($guid, $form_data, $fields)
	{
		$endpoint = 'forms/'.$guid;
		$form_data['fields'] = $fields;
		try{
	...
	*@throws HubSpotException
	**/
	public function getFields($guid)
	{
	...
	*@throws HubSpotException
	**/
	public function getSingleField($guid, $field_name)
	{
