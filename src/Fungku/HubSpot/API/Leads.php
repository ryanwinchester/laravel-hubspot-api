...
class Leads extends BaseClient {
    ...
    * @throws HubSpotException
    **/
    public function update($leadGuid, $updateData)
    {
        $endpoint = 'lead/' . $leadGuid;
    ...
    * @throws HubSpotException
    **/
    public function close($leadGuid, $closeDate)
    {
        $endpoint = 'lead/' . $leadGuid;
        $updateData = array();
        $updateData['id'] = $leadGuid;
    ...
    * @throws HubSpotException
    **/
    public function add($formURL, $postFields)
    {
    ...
    * @throws HubSpotException
    **/
    public function deleteWebhook($webhookGuid) {
