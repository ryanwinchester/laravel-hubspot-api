...
class Blog extends BaseClient {
    ...
    **/
    public function all($params, $content_type)
    {
    ...
    * @throws HubSpotException
    **/
    public function find($params, $guid, $content_type)
    {
    ...
    * @throws HubSpotException
    **/
    public function getPosts($params, $guid, $content_type)
    {
    ...
    * @throws HubSpotException
    **/
    public function getComments($params, $guid, $content_type)
    {
    ...
    * @throws HubSpotException
    **/
    public function getPost($params, $guid, $content_type)
    {
    ...
    * @throws HubSpotException
    **/
    public function getPostComments($params, $post_guid, $content_type)
    {
    ...
    * @throws HubSpotException
    **/
    public function getComment($params, $comment_guid, $content_type)
    {
    ...
    * @throws HubSpotException
    **/
    public function createPost($blog_guid, $author_name, $author_email, $title, $summary, $post_content, $tags)
    {
    ...
    * @throws HubSpotException
    **/
    public function updatePost($post_guid, $title, $summary, $post_content, $tags, $meta_desc, $keywords)
    {
    ...
    * @throws HubSpotException
    **/
    public function publishPost($post_guid, $publish_time, $should_notify)
    {
        $endpoint = 'posts/' . $post_guid . '.atom';
    ...
    * @throws HubSpotException
    **/
    public function createComment($post_guid, $author_name, $author_email, $url, $comment)
    {
